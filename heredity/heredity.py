...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            prob_from_mother = get_parent_prob(mother)
            prob_from_father = get_parent_prob(father)

            if genes == 2:
                prob_gene = prob_from_mother * prob_from_father
            elif genes == 1:
                prob_gene = (
                ...
                prob_gene = (1 - prob_from_mother) * (1 - prob_from_father)
